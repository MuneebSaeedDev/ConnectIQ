...
Cohesion: 0.09
Nodes (18): AdvancedSettingsSection(), DataExtractionSection(), DataSamplingPreviewSection(), DiscardChangesModal(), DuplicateNodeModal(), LiveValidationCard(), MonitoringSection(), RuntimeConfigSection() (+10 more)
...
Cohesion: 0.11
Nodes (20): AuthenticationSection(), GeneralInfoSection(), SourceConfigSection(), AUTH_METHODS, BASELINE_LIVE_VALIDATIONS, BASELINE_PREVIEW_DATA, BASELINE_SCHEMA_MAPPINGS, CATEGORIES (+12 more)
...
### Community 68 - "ValidationNodeConfigScreen.jsx"
Cohesion: 0.06
...
### Community 75 - "react"
Cohesion: 0.06
Nodes (27): react, AddRuleModal(), AdvancedConfigSection(), BottomTelemetryPanel(), DataCleaningSection(), DiscardChangesModal(), DuplicateNodeModal(), DuplicateRemovalSection() (+19 more)

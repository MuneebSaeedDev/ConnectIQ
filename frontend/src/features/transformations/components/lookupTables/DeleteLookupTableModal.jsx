...
export default function DeleteLookupTableModal({
  isOpen,
  table,
  isDeleting,
  onClose,
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-2">
                <p className="text-sm text-slate-500">
                  Are you sure you want to delete the lookup table <span className="font-semibold text-slate-900">{table.name}</span>?
                ...
                {table.pipelinesCount > 0 && (
                  <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-md flex gap-2">
                    ...
                    <div className="text-xs text-amber-800">
                      <strong>Warning:</strong> This table is currently referenced in <strong>{table.pipelinesCount} active pipeline(s)</strong>.
                      Deleting it will cause lookup transformation nodes in those pipelines to fail or default.
                    </div>
                  </div>
                )}
              </div>

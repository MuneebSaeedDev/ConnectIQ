...
export const DateFormattingRulesHeader = ({ onCreateClick, onRefresh, onImport, onExport }) => {
  return (
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between py-6 gap-4">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-slate-600 mt-1">
              Configure reusable date parsing, standardizing, and timezone conversion rules for ETL pipelines.
            </p>
          </div>

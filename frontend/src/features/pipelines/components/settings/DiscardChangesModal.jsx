      ...
      <div className="bg-white rounded-lg shadow-xl border border-slate-200 max-w-md w-full overflow-hidden">
        ...
        <div className="p-4 space-y-3">
          <p className="text-xs text-slate-600 leading-relaxed">
            You have <span className="font-semibold text-slate-900">{unsavedChangesCount}</span> unsaved {unsavedChangesCount === 1 ? 'change' : 'changes'} in this pipeline settings configuration. Leaving now will discard all modified execution, error handling, retry, and notification settings.
          </p>
        </div>

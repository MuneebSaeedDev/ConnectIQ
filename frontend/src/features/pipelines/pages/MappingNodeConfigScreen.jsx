...
import { useMappingNodeConfig } from '../hooks/useMappingNodeConfig';
import MappingNodeHeader from '../components/mappingNode/MappingNodeHeader';
import GeneralInfoSection from '../components/mappingNode/GeneralInfoSection';
import InputTargetSchemasSection from '../components/mappingNode/InputTargetSchemasSection';
import AutoMappingSection from '../components/mappingNode/AutoMappingSection';
import MappingWorkspaceSection from '../components/mappingNode/MappingWorkspaceSection';
import TransformationConfigSection from '../components/mappingNode/TransformationConfigSection';
import DataTypeAndNullSection from '../components/mappingNode/DataTypeAndNullSection';
import DataPreviewSection from '../components/mappingNode/DataPreviewSection';
import RuntimeAndMonitoringSection from '../components/mappingNode/RuntimeAndMonitoringSection';
import AdvancedConfigSection from '../components/mappingNode/AdvancedConfigSection';
import LiveValidationPanel from '../components/mappingNode/LiveValidationPanel';
import MappingNodeSummaryRail from '../components/mappingNode/MappingNodeSummaryRail';
import StickyFooterActionBar from '../components/mappingNode/StickyFooterActionBar';
import AddMappingModal from '../components/mappingNode/AddMappingModal';
import PreviewMatchesModal from '../components/mappingNode/PreviewMatchesModal';
import DuplicateNodeModal from '../components/mappingNode/DuplicateNodeModal';
import DiscardChangesModal from '../components/mappingNode/DiscardChangesModal';
import { AlertCircle, CheckCircle2, Info, Loader2 } from 'lucide-react';

export default function MappingNodeConfigScreen() {
  ...
  const {
    ...
    handleDuplicate,
    handleFixValidation,
  } = useMappingNodeConfig(nodeId, pipelineId);

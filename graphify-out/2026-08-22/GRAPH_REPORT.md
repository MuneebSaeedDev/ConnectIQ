...
## Corpus Check
- 105 files · ~87,975 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 712 nodes · 998 edges · 45 communities (37 shown, 8 thin omitted)
...
9. `Dependency Notes` - 11 edges
10. `useTwoFactor()` - 10 edges
...
- `useTwoFactor()` --calls--> `useAppSelector`  [EXTRACTED]
  frontend/src/features/auth/hooks/useTwoFactor.js → frontend/src/app/hooks.js
...
Cohesion: 0.08
Nodes (43): useAppDispatch, useAppSelector, maskEmail(), useEmailVerification(), resend(), useLogin(), submit(), validate() (+35 more)
...
Cohesion: 0.08
Nodes (41): env, confirmPasswordReset(), login(), LoginError, logout(), PasswordResetConfirmError, PasswordResetError, requestPasswordReset() (+33 more)
...
Cohesion: 0.07
Nodes (26): Conflicts / ambiguities, Design system, Figma Notes, Figma Screen Inventory, Missing or inaccessible Figma information, MOD-001 AppShell visual-polish redesign (2026-08-22), MOD-001 shared shell build notes (2026-08-22), SCR-002 build notes (2026-08-22) (+18 more)
...
- **Why does `react` connect `router.jsx` to `apiFetch`, `AppShell.jsx`, `DataQualityScreen.jsx`, `ExecutiveDashboardScreen.jsx`, `PipelineOverviewScreen.jsx`, `index.js`, `SystemHealthScreen.jsx`, `useTwoFactor`, `Header.jsx`, `SourceHealthScreen.jsx`, `.oxlintrc.json`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `apiFetch()` connect `apiFetch` to `router.jsx`, `PipelineOverviewScreen.jsx`?**

# Graph Report - Intern Project  (2026-08-24)

## Corpus Check
- 138 files · ~167,671 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1135 nodes · 1677 edges · 67 communities (57 shown, 10 thin omitted)
...
- `handleConfirmSave()` --calls--> `updateOrganization()`  [EXTRACTED]
  frontend/src/features/organizations/pages/EditOrganizationScreen.jsx → frontend/src/features/organizations/services/editOrganization.api.js
- `submit()` --calls--> `login()`  [EXTRACTED]
  frontend/src/features/auth/hooks/useLogin.js → frontend/src/features/auth/services/auth.api.js
...
### Community 0 - "executionStats.api.js"
Cohesion: 0.47
...
Cohesion: 0.07
Nodes (15): usePerformanceAnalytics(), BAR_TONE, ComponentsTable(), KPI_ICON, KPI_TONE, PerformanceAnalyticsScreen(), PRIORITY_BADGE, RANGES (+7 more)
...
Cohesion: 0.05
Nodes (58): useAppDispatch, useAppSelector, maskEmail(), useEmailVerification(), resend(), useLogin(), submit(), validate() (+50 more)
...
Cohesion: 0.09
Nodes (7): KPI_TONE, ORG_TONE, OrganizationListScreen(), OrganizationsTable(), PLAN_TONE, STATUS_TONE, AppShell()
...
Cohesion: 0.17
Nodes (19): confirmPasswordReset(), login(), logout(), requestPasswordReset(), resendTwoFactorCode(), resendVerificationEmail(), verifyTwoFactorCode(), ErrorAnalyticsError (+11 more)

### Community 55 - "EditForm"
Cohesion: 0.19
Nodes (17): computeChecklist(), displayValue(), EditForm(), guardedNavigate(), handleCancel(), handleConfirmSave(), isModified(), markTouched() (+9 more)

### Community 56 - "editOrganization.api.js"
Cohesion: 0.21
Nodes (11): useEditableOrganization(), EditOrganizationScreen(), createOrganization(), CreateOrganizationError, ORG_FORM_OPTIONS, PLAN_CATALOG, SUBSCRIPTION_PLANS, buildBaseline() (+3 more)

### Community 57 - "client.js"
Cohesion: 0.20
Nodes (7): env, DashboardError, getDashboardSummary(), MOCK_SUMMARY, getSystemHealth(), MOCK_SYSTEM_HEALTH, SystemHealthError

### Community 58 - "organizationList.api.js"
Cohesion: 0.47
Nodes (4): useOrganizationList(), getOrganizationList(), MOCK_ORGANIZATION_LIST, OrganizationListError

### Community 59 - "dataQuality.api.js"
Cohesion: 0.50
Nodes (3): DataQualityError, getDataQuality(), MOCK_DATA_QUALITY

### Community 60 - "executionStatistics.api.js"
Cohesion: 0.50
Nodes (3): ExecutionStatisticsError, getExecutionStatistics(), MOCK_EXECUTION_STATISTICS

### Community 61 - "performanceAnalytics.api.js"
Cohesion: 0.50
Nodes (3): getPerformanceAnalytics(), MOCK_PERFORMANCE_ANALYTICS, PerformanceAnalyticsError

### Community 62 - "sourceHealth.api.js"
Cohesion: 0.50
Nodes (3): getSourceHealth(), MOCK_SOURCE_HEALTH, SourceHealthError

### Community 63 - "ConfirmDialog"
Cohesion: 1.00
Nodes (3): ConfirmDialog(), getFocusable(), handleKeyDown()

## Knowledge Gaps
- **404 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+399 more)
...
- **Why does `react` connect `router.jsx` to `ErrorAnalyticsScreen.jsx`, `AppShell.jsx`, `DataQualityScreen.jsx`, `ExecutiveDashboardScreen.jsx`, `PipelineOverviewScreen.jsx`, `index.js`, `SystemHealthScreen.jsx`, `DestinationHealthScreen.jsx`, `ExecutionStatisticsScreen.jsx`, `CreateOrganizationScreen.jsx`, `RealTimeMonitoringScreen.jsx`, `.oxlintrc.json`, `SourceHealthScreen.jsx`, `EditOrganizationScreen.jsx`, `OrganizationListScreen.jsx`, `Header.jsx`, `OrganizationSettingsScreen.jsx`, `PerformanceAnalyticsScreen.jsx`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `AppShell()` connect `OrganizationListScreen.jsx` to `ErrorAnalyticsScreen.jsx`, `AppShell.jsx`, `DataQualityScreen.jsx`, `ExecutiveDashboardScreen.jsx`, `PipelineOverviewScreen.jsx`, `DashboardScreen.jsx`, `SystemHealthScreen.jsx`, `DestinationHealthScreen.jsx`, `ExecutionStatisticsScreen.jsx`, `router.jsx`, `RealTimeMonitoringScreen.jsx`, `SourceHealthScreen.jsx`, `CreateOrganizationScreen.jsx`, `EditOrganizationScreen.jsx`, `OrganizationDetailsScreen.jsx`, `OrganizationSettingsScreen.jsx`, `PerformanceAnalyticsScreen.jsx`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `apiFetch()` connect `apiFetch` to `executionStats.api.js`, `ExecutiveDashboardScreen.jsx`, `DestinationHealthScreen.jsx`, `router.jsx`, `OrganizationDetailsScreen.jsx`, `Header.jsx`, `OrganizationSettingsScreen.jsx`, `editOrganization.api.js`, `client.js`, `organizationList.api.js`, `dataQuality.api.js`, `executionStatistics.api.js`, `performanceAnalytics.api.js`, `sourceHealth.api.js`?**
...
- **Should `AppShell.jsx` be split into smaller, more focused modules?**

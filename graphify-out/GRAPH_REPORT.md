...
## Corpus Check
- 141 files · ~173,925 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1168 nodes · 1724 edges · 63 communities (55 shown, 8 thin omitted)
...
Cohesion: 0.16
Nodes (16): env, resend(), resendTwoFactorCode(), run(), checkConnectivity(), loadPlatformConfig(), restoreSession(), useExecutionStats() (+8 more)
...
### Community 46 - "ForgetPasswordScreen.jsx"
Cohesion: 0.17
Nodes (16): useResetPasswordConfirm(), submit(), validate(), ForgetPasswordScreen(), handleSubmit(), confirmPasswordReset(), SettingsShellScaffold(), useChangePassword() (+8 more)
...
### Community 56 - "router.jsx"
Cohesion: 0.23
Nodes (8): useResetPasswordRequest(), submit(), validate(), ResetPasswordScreen(), handleSubmit(), requestPasswordReset(), RoutePlaceholder(), inputBase

### Community 57 - "react"
Cohesion: 0.45
Nodes (5): useAppDispatch, useAppSelector, useBootstrap(), SplashScreen(), react

### Community 58 - "useTwoFactor"
Cohesion: 0.29
Nodes (7): useTwoFactor(), handleKeyDown(), setDigit(), submit(), TwoFactorAuthenticationScreen(), handleSubmit(), verifyTwoFactorCode()

### Community 59 - "useLogout.js"
Cohesion: 0.36
Nodes (6): useLogout(), confirm(), reset(), LogoutScreen(), handleConfirm(), logout()

### Community 60 - "useLogin"
Cohesion: 0.38
Nodes (6): useLogin(), submit(), validate(), LoginScreen(), handleSubmit(), login()

## Knowledge Gaps
- **410 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+405 more)
...
- **Why does `react` connect `react` to `apiFetch`, `ErrorAnalyticsScreen.jsx`, `AppShell.jsx`, `DataQualityScreen.jsx`, `ExecutiveDashboardScreen.jsx`, `PipelineOverviewScreen.jsx`, `index.js`, `CreateOrganizationScreen.jsx`, `SourceHealthScreen.jsx`, `PerformanceAnalyticsScreen.jsx`, `SystemHealthScreen.jsx`, `DestinationHealthScreen.jsx`, `ExecutionStatisticsScreen.jsx`, `ForgetPasswordScreen.jsx`, `RealTimeMonitoringScreen.jsx`, `.oxlintrc.json`, `OrganizationListScreen.jsx`, `EditOrganizationScreen.jsx`, `Header.jsx`, `OrganizationSettingsScreen.jsx`, `auth.api.js`, `DepartmentManagementScreen.jsx`, `router.jsx`, `useTwoFactor`, `useLogout.js`?**
  _High betweenness centrality (0.158) - this node is a cross-community bridge._
- **Why does `AppShell()` connect `DashboardScreen.jsx` to `ErrorAnalyticsScreen.jsx`, `AppShell.jsx`, `DataQualityScreen.jsx`, `ExecutiveDashboardScreen.jsx`, `PipelineOverviewScreen.jsx`, `SystemHealthScreen.jsx`, `DestinationHealthScreen.jsx`, `ExecutionStatisticsScreen.jsx`, `CreateOrganizationScreen.jsx`, `RealTimeMonitoringScreen.jsx`, `SourceHealthScreen.jsx`, `OrganizationListScreen.jsx`, `EditOrganizationScreen.jsx`, `OrganizationDetailsScreen.jsx`, `OrganizationSettingsScreen.jsx`, `DepartmentManagementScreen.jsx`, `router.jsx`, `PerformanceAnalyticsScreen.jsx`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `apiFetch()` connect `apiFetch` to `ErrorAnalyticsScreen.jsx`, `DataQualityScreen.jsx`, `ExecutiveDashboardScreen.jsx`, `PipelineOverviewScreen.jsx`, `DashboardScreen.jsx`, `SourceHealthScreen.jsx`, `PerformanceAnalyticsScreen.jsx`, `SystemHealthScreen.jsx`, `DestinationHealthScreen.jsx`, `ExecutionStatisticsScreen.jsx`, `ForgetPasswordScreen.jsx`, `RealTimeMonitoringScreen.jsx`, `OrganizationListScreen.jsx`, `EditOrganizationScreen.jsx`, `OrganizationDetailsScreen.jsx`, `Header.jsx`, `OrganizationSettingsScreen.jsx`, `auth.api.js`, `DepartmentManagementScreen.jsx`, `router.jsx`, `useTwoFactor`, `useLogout.js`, `useLogin`?**

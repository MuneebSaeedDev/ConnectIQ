# Graph Report - ConnectIQ  (2026-09-07)

## Corpus Check
- 228 files · ~450,195 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2770 nodes · 4357 edges · 146 communities (132 shown, 14 thin omitted)
...
1. `apiFetch()` - 136 edges
2. `readJson()` - 128 edges
3. `react` - 71 edges
4. `AppShell()` - 51 edges
...
### Community 10 - "react"
Cohesion: 0.26
Nodes (9): useResetPasswordConfirm(), submit(), validate(), ForgetPasswordScreen(), handleSubmit(), confirmPasswordReset(), PasswordResetConfirmError, inputBase (+1 more)
...
### Community 61 - "useResetPasswordRequest"
Cohesion: 0.60
...
### Community 66 - "inspect_scr062_sections.js"
Cohesion: 0.40
Nodes (4): fs, lines, sections, xml
...
### Community 77 - "readJson"
Cohesion: 0.05
Nodes (43): env, useDashboardSummary(), useExecutionStats(), DashboardScreen(), HEALTH_BAR_TONE, HEALTH_DOT_TONE, healthBarTone(), HealthMeterRow() (+35 more)

### Community 78 - "apiFetch"
Cohesion: 0.20
Nodes (18): useAppDispatch, useAppSelector, maskEmail(), useEmailVerification(), resend(), EmailVerificationScreen(), confirmEmailVerification(), EmailVerificationError (+10 more)
...
### Community 112 - "AppShell"
Cohesion: 0.06
Nodes (20): AddDestinationScreen(), DESTINATION_TYPES, INITIAL_FORM, createDestination(), DestinationError, ORG_ID, testConnection(), validateDestination() (+12 more)
...
### Community 115 - "CreatePipelineScreen.jsx"
Cohesion: 0.29
...
Cohesion: 0.18
Nodes (9): App(), queryClient, router, useLogout(), confirm(), reset(), LogoutScreen(), handleConfirm() (+1 more)
...
### Community 143 - "useLogin"
Cohesion: 0.47
Nodes (5): useLogin(), submit(), validate(), LoginScreen(), handleSubmit()

### Community 144 - "parse_sections.js"
Cohesion: 0.33
Nodes (5): curSection, fs, lines, sections, xml
...
### Community 146 - "inspect_scr062.js"
Cohesion: 0.40
Nodes (4): frames, fs, lines, xml

### Community 147 - "parse_figma.js"
Cohesion: 0.40
Nodes (4): fs, lines, out, xml

### Community 148 - "ConfirmDialog"
Cohesion: 0.67
Nodes (4): ConfirmDialog(), getFocusable(), handleKeyDown(), formatRows()

### Community 149 - "Header"
Cohesion: 0.67
Nodes (3): Header(), getFocusable(), handleKeyDown()

## Knowledge Gaps
- **577 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+572 more)
...
- **Why does `react` connect `react` to `TeamManagementScreen.jsx`, `Sidebar.jsx`, `ErrorAnalyticsScreen.jsx`, `permissions.js`, `DataQualityScreen.jsx`, `ExecutiveDashboardScreen.jsx`, `PipelineOverviewScreen.jsx`, `AppShell.jsx`, `CreateOrganizationScreen.jsx`, `SourceHealthScreen.jsx`, `PerformanceAnalyticsScreen.jsx`, `SystemHealthScreen.jsx`, `DestinationHealthScreen.jsx`, `ExecutionStatisticsScreen.jsx`, `RealTimeMonitoringScreen.jsx`, `.oxlintrc.json`, `RoleListScreen.jsx`, `EditOrganizationScreen.jsx`, `EditUserScreen.jsx`, `OrganizationSettingsScreen.jsx`, `OrganizationActivityScreen.jsx`, `DepartmentManagementScreen.jsx`, `AddUserScreen.jsx`, `UserListScreen.jsx`, `UserProfileScreen.jsx`, `AccessControlSettingsScreen.jsx`, `useTwoFactor`, `PermissionMatrixScreen.jsx`, `ApiConnectorSetupScreen.jsx`, `EditRoleScreen.jsx`, `useBootstrap.js`, `UserActivityHistoryScreen.jsx`, `UserPermissionManagementScreen.jsx`, `readJson`, `apiFetch`, `DestinationListScreen.jsx`, `UserLoginHistoryScreen.jsx`, `useChangePassword.js`, `CreateRoleScreen.jsx`, `DatabaseConnectorSetupScreen.jsx`, `Header.jsx`, `SourceConnectionSetupScreen.jsx`, `ConnectionTestResultScreen.jsx`, `FtpConnectionScreen.jsx`, `CsvUploadScreen.jsx`, `AddDataSourceScreen.jsx`, `DataSourceListScreen.jsx`, `ExcelUploadScreen.jsx`, `AppShell`, `CreatePipelineScreen.jsx`, `SftpConnectionScreen.jsx`, `SourceHealthMonitoringScreen.jsx`, `router.jsx`, `WebhookConfigurationScreen.jsx`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `AppShell()` connect `AppShell` to `TeamManagementScreen.jsx`, `ErrorAnalyticsScreen.jsx`, `DataQualityScreen.jsx`, `ExecutiveDashboardScreen.jsx`, `PipelineOverviewScreen.jsx`, `AppShell.jsx`, `CreateOrganizationScreen.jsx`, `SourceHealthScreen.jsx`, `PerformanceAnalyticsScreen.jsx`, `SystemHealthScreen.jsx`, `DestinationHealthScreen.jsx`, `ExecutionStatisticsScreen.jsx`, `UserDetailsScreen.jsx`, `RealTimeMonitoringScreen.jsx`, `RoleListScreen.jsx`, `EditOrganizationScreen.jsx`, `OrganizationDetailsScreen.jsx`, `EditUserScreen.jsx`, `OrganizationSettingsScreen.jsx`, `OrganizationActivityScreen.jsx`, `DepartmentManagementScreen.jsx`, `AddUserScreen.jsx`, `UserListScreen.jsx`, `UserProfileScreen.jsx`, `AccessControlSettingsScreen.jsx`, `PermissionMatrixScreen.jsx`, `ApiConnectorSetupScreen.jsx`, `EditRoleScreen.jsx`, `UserActivityHistoryScreen.jsx`, `UserPermissionManagementScreen.jsx`, `readJson`, `DestinationListScreen.jsx`, `UserLoginHistoryScreen.jsx`, `CreateRoleScreen.jsx`, `DatabaseConnectorSetupScreen.jsx`, `SourceConnectionSetupScreen.jsx`, `ConnectionTestResultScreen.jsx`, `FtpConnectionScreen.jsx`, `CsvUploadScreen.jsx`, `AddDataSourceScreen.jsx`, `DataSourceListScreen.jsx`, `ExcelUploadScreen.jsx`, `CreatePipelineScreen.jsx`, `SftpConnectionScreen.jsx`, `SourceHealthMonitoringScreen.jsx`, `router.jsx`, `WebhookConfigurationScreen.jsx`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `apiFetch()` connect `apiFetch` to `TeamManagementScreen.jsx`, `ErrorAnalyticsScreen.jsx`, `excelUpload.api.js`, `WebhookConfigurationScreen`, `DataQualityScreen.jsx`, `ExecutiveDashboardScreen.jsx`, `PipelineOverviewScreen.jsx`, `importWorkbook`, `EditForm`, `react`, `notifications.api.js`, `CreateOrganizationScreen.jsx`, `SourceHealthScreen.jsx`, `createDataSource`, `PerformanceAnalyticsScreen.jsx`, `SystemHealthScreen.jsx`, `DestinationHealthScreen.jsx`, `ExecutionStatisticsScreen.jsx`, `UserDetailsScreen.jsx`, `RealTimeMonitoringScreen.jsx`, `RoleListScreen.jsx`, `OrganizationDetailsScreen.jsx`, `OrganizationSettingsScreen.jsx`, `OrganizationActivityScreen.jsx`, `DepartmentManagementScreen.jsx`, `AddUserScreen.jsx`, `editUser.api.js`, `UserListScreen.jsx`, `EditForm`, `ProfileForm`, `editRole.api.js`, `ApiConnectorSetupScreen.jsx`, `SettingsForm`, `useBootstrap.js`, `userProfile.api.js`, `UserActivityHistoryScreen.jsx`, `UserPermissionManagementScreen.jsx`, `readJson`, `DestinationListScreen.jsx`, `UserLoginHistoryScreen.jsx`, `useChangePassword.js`, `permissionMatrix.api.js`, `accessControlSettings.api.js`, `DatabaseConnectorSetupScreen.jsx`, `ConnectionTestResultScreen.jsx`, `createRole.api.js`, `FtpConnectionScreen.jsx`, `csvUpload.api.js`, `createRole`, `AddDataSourceScreen.jsx`, `DataSourceListScreen.jsx`, `getPermissionMatrix`, `editOrganization.api.js`, `AppShell`, `CreatePipelineScreen.jsx`, `SourceHealthMonitoringScreen.jsx`, `uploadCsvFile`, `EditForm`, `startCsvImport`, `sftpConnection.api.js`, `SftpConnectionScreen`, `webhookConfiguration.api.js`?**

...
## Corpus Check
- 144 files · ~180,551 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1202 nodes · 1772 edges · 57 communities (49 shown, 8 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `24dee9a9`
...
### Community 10 - "readJson"
Cohesion: 0.07
Nodes (23): env, useDashboardSummary(), useExecutionStats(), DashboardScreen(), HEALTH_BAR_TONE, HEALTH_DOT_TONE, healthBarTone(), HealthMeterRow() (+15 more)

### Community 11 - "CreateOrganizationScreen.jsx"
Cohesion: 0.07
Nodes (29): useEditableOrganization(), buildPayload(), computeChecklist(), ConfirmDialog(), getFocusable(), handleKeyDown(), CreateOrganizationScreen(), handleConfirmCreate() (+21 more)
...
## Knowledge Gaps
- **417 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+412 more)

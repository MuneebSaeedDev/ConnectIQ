...
## Corpus Check
- 211 files · ~373,718 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2613 nodes · 4085 edges · 135 communities (122 shown, 13 thin omitted)
...
### Community 10 - "useResetPasswordConfirm.js"
Cohesion: 0.23
...
Cohesion: 0.07
Nodes (23): CHANGE_LABELS, computeChecklist(), ConfirmDialog(), getFocusable(), handleKeyDown(), displayValue(), EDITABLE_KEYS, EditForm() (+15 more)
...
Cohesion: 0.08
Nodes (6): AVATAR_TONE, KPI_TONE, ROLE_TONE, STATUS_TONE, UserListScreen(), UsersTable()
...
Cohesion: 0.39
Nodes (7): QUERY_KEY, useNotifications(), getNotifications(), markAllNotificationsRead(), MOCK_NOTIFICATIONS, NotificationsError, apiFetch()
...
Cohesion: 0.16
Nodes (15): useConnectionTestResult(), ConnectionTestResultScreen(), handleCopyDiagnostics(), handleSave(), ResultBanner(), STATUS_LABEL, STATUS_TONE, tone() (+7 more)
...
Cohesion: 0.20
Nodes (10): env, useExecutionStats(), ExecutionStatsError, getExecutionStats(), MOCK_EXECUTION_STATS, useUserList(), getUserList(), MOCK_USER_LIST (+2 more)
...
### Community 128 - "UserDrawer"
Cohesion: 1.00
Nodes (3): UserDrawer(), getFocusable(), handleKeyDown()
